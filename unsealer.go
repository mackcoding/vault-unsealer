...
func main() {
    ...
    apiUrl, identityUrl, vaultUrls, orgId, token := getVariables()
    ...
    unsealVault(unsealKeys, vaultUrls)
...
func getVariables() (apiUrl string, identityUrl string, vaultUrls []string, orgId string, token string) {
    ...
    // Log all variables, showing lengths for secure ones
...
func unsealVault(keys []string, urls []string) {
